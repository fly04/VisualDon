const villes = [
  ...
  */
  ...
  const villesDePlusDe30000Habitants = villes.filter(d => {
    if(d.population >= 30000) return d.nom;
  })
  ...
  */
  ...
  const sommeHabitants = villes.reduce((valCourante, ville) => valCourante + ville.population, 0);
